...
export const part2Content: Part = {
  ...
  chapters: [
    {
        id: "p2_c1",
        chapterTitle: "الفصل الأول: تثبيت وتكوين Nginx",
        sections: [
            {
              id: "p2_c1_s1",
              icon: "🔌",
...
sudo chmod -R 755 /var/www`, explanations: [
    ...
    {
        id: "p2_c2",
        chapterTitle: "الفصل الثاني: Nginx كوكيل عكسي (Reverse Proxy)",
        sections: [
            {
              id: "p2_c2_s1",
              icon: "🔄",
...
app.wsgi_app = ProxyFix(app.wsgi_app, x_for=1, x_proto=1)` },
    ...
    {
        id: "p2_c3",
        chapterTitle: "الفصل الثالث: إعداد قاعدة البيانات (PostgreSQL)",
        sections: [
            {
              id: "p2_c3_s1",
              icon: "🤔",
...
`, explanations: [
    ...
    {
        id: "p2_c4",
        chapterTitle: "الفصل الرابع: تثبيت بيئات التشغيل",
        sections: [
            {
              id: "p2_c4_s1",
              icon: "🚀",
...
# ... other service directives ...` },
    ...
    {
        id: "p2_c5",
        chapterTitle: "الفصل الخامس: نشر أول تطبيق متكامل",
        sections: [
            {
              id: "p2_c5_s1",
              icon: "🧩",
