...
export const part3Content: Part = {
  ...
  chapters: [
    {
        id: "p3_c1", chapterTitle: "الفصل الأول: إدارة الكود ونشره",
        sections: [
            {
              id: "p3_c1_s1",
              icon: "🔧",
              ...
              content: [
                ...
                { type: ContentType.NOTE, title: "الهدف النهائي", text: "الهدف هو تحويل النشر من حدث مرهق ومحفوف بالمخاطر إلى عملية روتينية ومملة وغير مؤلمة. استخدام Git بشكل صحيح على الخادم هو الخطوة الأولى والأساسية لتحقيق هذا الهدف." },
              ]
            },
            {
              id: "p3_c1_s2",
              icon: "🏗️",
              title: "المستوى 51: إعداد مستودع Git مركزي على الخادم (Bare Repository)",
              content: [
...
git init --bare`, explanations: [
                ...
                { type: ContentType.HEADING4, text: "ربط جهازك المحلي بالخادم" },
...
git push production main`, explanations: [
                ...
                { type: ContentType.NOTE, title: "مصادقة مفتاح SSH ضرورية", text: "لكي يعمل هذا بسلاسة وبشكل آمن، يجب أن تكون قد قمت بالفعل بإعداد مصادقة مفتاح SSH للوصول إلى خادمك (كما فعلنا في الباب الأول). هذا يسمح لـ Git بالاتصال بشكل آمن دون مطالبتك بكلمة مرور في كل مرة تقوم فيها بالدفع." },
              ]
            },
            {
              id: "p3_c1_s3",
              icon: "🚚",
              title: "المستوى 52: نشر الكود: استنساخ وسحب (Deploying the Code: Clone and Pull)",
              content: [
...
sudo chown -R nagi:nagi /var/www/my-app`, explanations: [
                ...
                { type: ContentType.HEADING4, text: "سير عمل النشر اليدوي" },
...
pm2 reload my-app`, explanations: [
            ...
            },
            {
              id: "p3_c1_s4",
              icon: "🤖",
              title: "المستوى 53: أتمتة النشر البسيط باستخدام Git Hooks",
              content: [
                ...
                { type: ContentType.HEADING4, text: "إنشاء نص `post-receive` البرمجي" },
...
echo "====== DEPLOYMENT SCRIPT FINISHED ======"`, explanations: [
            ...
            },
            {
              id: "p3_c1_s5",
              icon: "🔒",
              title: "المستوى 54: التعامل مع ملفات التكوين والأسرار في Git",
              content: [
                ...
                { type: ContentType.HEADING4, text: "الحل: فصل الكود عن التكوين" },
                ...
                { type: ContentType.HEADING4, text: "الخطوة 1: `.gitignore`" },
                { type: ContentType.PARAGRAPH, text: "تأكد من أن ملف `.gitignore` في جذر مشروعك يتضمن أي ملفات أو مجلدات حساسة. هذا يخبر Git بعدم تتبعها أبدًا." },
...
dist/` },
                { type: ContentType.HEADING4, text: "الخطوة 2: قالب التكوين (`.env.example`)" },
                { type: ContentType.PARAGRAPH, text: "للمساعدة في توثيق المتغيرات التي يحتاجها تطبيقك، من الممارسات الجيدة إنشاء ملف قالب. هذا الملف يتم إدراجه في Git." },
...
STRIPE_API_KEY=` },
    ...
    {
        id: "p3_c2", chapterTitle: "الفصل الثاني: مقدمة إلى CI/CD",
        sections: [
            {
              id: "p3_c2_s1",
              icon: "🤔",
              title: "المستوى 55: ما هو CI/CD ولماذا هو مهم؟",
              content: [
                ...
                { type: ContentType.HEADING4, text: "لماذا هو أفضل من Git Hooks؟" },
            ...
            },
            {
              ...
              content: [
                ...
                { type: ContentType.IMAGE_PLACEHOLDER, alt: "مخطط يوضح العلاقة بين Workflow, Event, Job, Step, Action", width: 800, height: 450 },
            ...
            },
            {
              id: "p3_c2_s3",
              icon: "📄",
              title: "المستوى 57: إنشاء أول سير عمل (Workflow) للنشر",
              content: [
...
`, explanations: [
            ...
            },
            {
              id: "p3_c2_s4",
              icon: "🔑",
              title: "المستوى 58: استخدام أسرار GitHub لتخزين بيانات الاعتماد",
              content: [
                ...
                { type: ContentType.HEADING4, text: "إنشاء الأسرار اللازمة" },
...
jobs:
  deploy:
        ...
        with:
          ...
          script: |
            ...
            pm2 reload my-app`, explanations: [
                ...
                { type: ContentType.HEADING4, text: "النتيجة النهائية" },
    ...
    {
        id: "p3_c3", chapterTitle: "الفصل الثالث: بناء خطوط أنابيب متقدمة",
        sections: [
            {
              id: "p3_c3_s1",
              icon: "🧪",
              title: "المستوى 60: إضافة خطوة الاختبار (CI) إلى سير العمل",
              content: [
                { type: ContentType.PARAGRAPH, text: "الغرض الحقيقي من التكامل المستمر (CI) هو بناء الثقة في الكود الخاص بك قبل نشره. الطريقة الأكثر فعالية لبناء هذه الثقة هي من خلال الاختبار الآلي. في هذا المستوى، سنقوم بتوسيع سير عملنا ليشمل وظيفة اختبار منفصلة تعمل *قبل* وظيفة النشر. إذا فشلت أي من الاختبارات، فسيتم إيقاف خط الأنابيب بأكمله ولن يتم نشر الكود المعيب أبدًا." },
                { type: ContentType.HEADING4, text: "فصل الاختبار عن النشر" },
...
`, explanations: [
            ...
            },
            {
              id: "p3_c3_s2",
              icon: "📦",
              title: "المستوى 61: بناء الأصول (Assets) على GitHub Actions",
              content: [
                ...
                { type: ContentType.HEADING4, text: "مفهوم القطع الأثرية (Artifacts)" },
...
`, explanations: [
            ...
            },
            {
              id: "p3_c3_s3",
              icon: "⚡",
              title: "المستوى 62: استخدام rsync للنشر الفعال",
              content: [
                ...
                { type: ContentType.HEADING4, text: "استخدام إجراء `rsync`" },
...
`, explanations: [
            ...
            },
            {
              id: "p3_c3_s4",
              icon: "⏪",
              title: "المستوى 63: استراتيجيات التراجع (Rollback) البسيطة",
              content: [
                ...
                { type: ContentType.HEADING4, text: "الطريقة 2: `git revert`" },
...
git push origin main` },
            ...
            },
            {
              id: "p3_c3_s5",
              icon: "🔔",
              title: "المستوى 64: إرسال إشعارات حالة النشر (Slack/Discord)",
              content: [
                ...
                { type: ContentType.HEADING4, text: "استخدام Webhooks" },
                ...
                { type: ContentType.HEADING4, text: "إضافة خطوة الإشعار إلى سير العمل" },
...
`, explanations: [
    ...
    {
        id: "p3_c4", chapterTitle: "الفصل الرابع: التوزيع بدون توقف",
        sections: [
            {
              id: "p3_c4_s1",
              icon: "⏳",
              title: "المستوى 65: فهم مشكلة التوقف أثناء النشر",
              content: [
                ...
                { type: ContentType.HEADING4, text: "لماذا يحدث التوقف؟" },
                { type: ContentType.LIST_UNORDERED, items: [
                    "<strong>إعادة تشغيل العملية:</strong> تستغرق العملية الجديدة وقتًا لتبدأ. يجب عليها تحميل الكود، والاتصال بقاعدة البيانات، وتهيئة حالتها قبل أن تكون جاهزة لقبول الطلبات.",
                    "<strong>عمليات ترحيل قاعدة البيانات (Database Migrations):</strong> إذا كان نشرك يتضمن تغييرات في مخطط قاعدة البيانات، فقد تحتاج إلى وضع التطبيق في وضع الصيانة لمنع كتابة البيانات أثناء تغيير الجداول.",
                    "<strong>اعتماديات الخدمة:</strong> قد يحتاج تطبيقك إلى إعادة الاتصال بخدمات أخرى مثل Redis أو واجهات برمجة التطبيقات الخارجية عند بدء التشغيل."
                ]},
                { type: ContentType.NOTE, title: "PM2 Reload مقابل Restart", text: "`pm2 reload` أذكى من `pm2 restart`. إنه يحاول تحقيق النشر بدون توقف عن طريق الحفاظ على العملية القديمة قيد التشغيل حتى تصبح العملية الجديدة جاهزة. ومع ذلك، لا يزال هذا غير مضمون ويمكن أن يفشل في ظل ظروف معينة. الاستراتيجيات التي سنناقشها بعد ذلك، مثل النشر الأزرق/الأخضر، توفر نهجًا أكثر قوة وموثوقية لحل هذه المشكلة على مستوى البنية التحتية." },
              ]
            },
            {
              id: "p3_c4_s2",
              icon: "🔵🟢",
              title: "المستوى 66: استراتيجية النشر الأزرق/الأخضر (Blue/Green Deployment)",
              content: [
                ...
                { type: ContentType.IMAGE_PLACEHOLDER, alt: "مخطط يوضح خطوات النشر الأزرق/الأخضر", width: 800, height: 600 },
                { type: ContentType.LIST_UNORDERED, items: [
            ...
            },
            {
              id: "p3_c4_s3",
              icon: "🔄",
              title: "المستوى 67: التوزيع بدون انقطاع باستخدام PM2",
              content: [
                ...
                { type: ContentType.HEADING4, text: "كيف يعمل `pm2 reload`؟" },
                ...
                { type: ContentType.HEADING4, text: "تكوين الانتظار (`listen_timeout`)" },
  ...
  apps : [{
    ...
    kill_timeout: 5000     // Wait 5 seconds for the old process to shut down gracefully
                ...
                { type: ContentType.NOTE, title: "القيود", text: "هذه الطريقة فعالة للغاية للعديد من التطبيقات عديمة الحالة (stateless). ومع ذلك، فإنها لا تزال تحدث على نفس الخادم، وتستخدم نفس الموارد، ولا تعالج سيناريوهات النشر الأكثر تعقيدًا مثل تغييرات قاعدة البيانات الكبيرة أو الاختبار الشامل قبل التبديل. إنها خطوة أولى ممتازة نحو النشر بدون توقف، لكن استراتيجية الأزرق/الأخضر على مستوى Nginx توفر مستوى أعلى من العزل والأمان." },
              ]
            },
            {
              id: "p3_c4_s4",
              icon: "🔵🟢",
              title: "المستوى 68: تنفيذ النشر الأزرق/الأخضر باستخدام Nginx",
              content: [
    ...
    location / {
        ...
        # ... proxy headers ...
                ...
                { type: ContentType.HEADING4, text: "الخطوة 4: نص النشر الآلي" },
...
`, explanations: [
            ...
            },
            {
              id: "p3_c4_s5",
              icon: "🐦",
              title: "المستوى 69: مقدمة إلى النشر الكناري (Canary Deployment)",
              content: [
                ...
                { type: ContentType.HEADING4, text: "التنفيذ باستخدام Nginx" },
...
server {
    ...
    {
        id: "p3_c5", chapterTitle: "الفصل الخامس: أدوات CI/CD أخرى",
        sections: [
            {
              id: "p3_c5_s1",
              icon: "👴",
              title: "المستوى 70: نظرة عامة على Jenkins",
              content: [
            ...
            },
            {
              id: "p3_c5_s2",
              icon: "🦊",
              title: "المستوى 71: نظرة عامة على GitLab CI/CD",
              content: [
            ...
            },
            {
              id: "p3_c5_s3",
              icon: "🔵",
              title: "المستوى 72: نظرة عامة على CircleCI",
              content: [
            ...
            },
            {
              id: "p3_c5_s4",
              icon: "📊",
              title: "المستوى 73: مقارنة بين المنصات المختلفة",
              content: [
...
| الميزات الرئيسية  | تكامل سلس، مجتمع كبير                  | منصة DevOps شاملة، أمان مدمج           | تخصيص لا نهائي، مرونة                  | سرعة، أداء، تصحيح أخطاء SSH          |` },
            ...
            },
            {
              id: "p3_c5_s5",
              icon: "🎯",
              title: "المستوى 74: اختيار الأداة المناسبة لمشروعك",
              content: [
                ...
                { type: ContentType.NOTE, title: "المبادئ أهم من الأدوات", text: "الأداة التي تختارها أقل أهمية من المبادئ التي تطبقها. إن فهم مفاهيم التكامل المستمر، والنشر بدون توقف، والبنية التحتية ككود هو ما سيجعلك مهندسًا فعالاً. الأدوات تتغير، لكن المبادئ تبقى." },
              ]
            }
        ]
    },
