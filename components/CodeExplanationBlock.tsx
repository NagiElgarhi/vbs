...
const CodeExplanationBlock: React.FC<CodeExplanationBlockProps> = ({ language, code, explanations, codeTitle }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row my-6 bg-stone-800 rounded-lg shadow-lg border border-stone-700 overflow-hidden">
      ...
      <div className="w-full md:w-1/2 p-4 bg-stone-800 md:border-l-2 border-stone-700">
        <h4
        ...
        <div className="space-y-4">
          {explanations.map((item, index) => (
            <div key={index} className="flex">
              ...
              <p
                className="flex-grow mr-4 text-stone-300 leading-relaxed"
      ...
      <div dir="ltr" className="w-full md:w-1/2 bg-stone-900 flex flex-col border-t-2 md:border-t-0 border-stone-700">
        <div className="flex-shrink-0 flex items-center justify-between p-2 bg-stone-800 border-b border-stone-600">
          <div className="flex items-center space-x-2">
             {language && (
                <span className="px-2 py-1 bg-gray-700 text-gray-300 rounded-md text-xs font-bold select-none">
