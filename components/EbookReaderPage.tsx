  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-30 transition-transform duration-300 ease-in-out ${isHeaderVisible ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="h-[70px] bg-stone-700 text-stone-100 flex items-center justify-between px-8 shadow-lg relative">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-x-[25px]">
      ...
      <div className={`fixed left-1/2 -translate-x-1/2 top-0 z-30 transition-transform duration-300 ease-in-out ${isHeaderVisible ? 'translate-y-[70px]' : 'translate-y-0'}`}>
          <button
            ...
            >
                ...
                <div className="flex flex-col items-center justify-center h-full -mt-16">
                    <div className="decorative-frame max-w-2xl w-full text-center">
                        <h1 className="font-amiri text-5xl text-amber-200 p-8" lang="ar" dir="rtl">
                            وَقُل رَّبِّ زِدْنِي عِلْمًا
                        </h1>
                        <p className="text-stone-400 mt-2">اختر بابًا من الفهرس لبدء القراءة</p>
                    </div>
                    <div className="text-center mt-[100px]">
                        <p className="text-stone-400 text-lg" dir="ltr">Implemented by</p>
                        <p className="text-stone-300 text-xl font-bold font-code mt-1" dir="ltr">Nagi Hanafi Metwalli</p>
                    </div>
                </div>
                )}
